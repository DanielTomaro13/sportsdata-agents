...
cp "$REPO_DIR"/site/index.html "$REPO_DIR"/site/feeds.html "$REPO_DIR"/site/demo-fallback.json "$REPO_DIR"/site/catalogue.json "$REPO_DIR"/site/terms.html "$REPO_DIR"/site/privacy.html "$REPO_DIR"/site/refunds.html "$WORK"/
