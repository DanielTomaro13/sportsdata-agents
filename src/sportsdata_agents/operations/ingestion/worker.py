...
FEEDS: dict[str, Feed] = {
    ...
    "entain_books": Feed(
        name="entain_books",
        provider="entain",
        tool="entain_sport_event_card",
        mcp_groups=("entain.rest", "entain.graphql"),  # graphql: category discovery
        normalizer=normalize_entain_books,
        fetch=fetch_entain_books,
        interval_s=3600,
    ),
    "betr_books": Feed(
        name="betr_books",
        provider="betr",
        tool="betr_master_event",
        mcp_groups=("betr.sport",),
        normalizer=normalize_betr_books,
        fetch=fetch_betr_books,
        interval_s=3600,
    ),
    "tab_books": Feed(
        name="tab_books",
    ...
    "entain_racing": Feed(
        name="entain_racing",
        provider="entain_racing",
        tool="entain_racing_racecard",
        mcp_groups=("entain.rest",),
        normalizer=normalize_entain_races,
        fetch=fetch_entain_races,
        interval_s=60,
    ),
    "betr_racing": Feed(
        name="betr_racing",
